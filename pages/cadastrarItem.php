...
<meta charset="utf-8" />
    ...
    <title>BSnS Manager 1.0 - Cadastrar Item</title>
        ...
        <div id="formCadastroProduto">
            <form>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <label>Custo</label>
                        <input type="text" class="form-control form-control-sm" id="custo" disabled>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <label>Preço</label>
                        <input type="text" class="form-control form-control-sm" id="price" disabled>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-3">
